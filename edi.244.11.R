...
# purpose: wrangle DJFMP fish data from 1976-2022
# assumes: modified version of edi.244.11.r
# created: 2023-06-30
# last modified: 2023-07-14

# modifications lines 8-11 AND 1040-1044 only
setwd("G:/My Drive/GitHub Gdrive Projects/salmon_migration") # if necessary...
...
saveRDS(dt1, "data/dt1.rds") # Sacramento R below Sac and ds to include Delta; 1976-05-13 to 2001-12-31; region: 1=lower Sac R, 2=North Delta, 3=Central Delta, 4=South Delta, 5=San Joaquin R, 6=Bay Area, 7=Sacramento R
saveRDS(dt2, "data/dt2.rds") # Sacramento R below Sac and ds to include Delta; 2002-01-02 to ?; region: 1=lower Sac R, 2=North Delta, 3=Central Delta, 4=South Delta, 5=San Joaquin R, 6=Bay Area, 7=Sacramento R
saveRDS(dt3, "data/dt3.rds") # Sacramento R and lower tribs above Sac; 1976-03-08 to ?
saveRDS(dt4, "data/dt4.rds") # organism taxonomy and names
saveRDS(dt5, "data/dt5.rds") # lat & lon for stations by location and method